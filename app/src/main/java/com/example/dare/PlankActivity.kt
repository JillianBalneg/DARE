...
import com.example.dare.databinding.ActivityPlankBinding
import java.util.concurrent.TimeUnit

class PlankActivity : AppCompatActivity() {

    private lateinit var binding: ActivityPlankBinding

    companion object {
        const val TAG = "PlankActivity"
    }
    private var isStarted = false
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPlankBinding.inflate(layoutInflater)
