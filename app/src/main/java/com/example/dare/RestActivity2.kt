...
import com.example.dare.databinding.ActivityRest2Binding
import java.util.concurrent.TimeUnit

class RestActivity2 : AppCompatActivity() {

    private lateinit var binding: ActivityRest2Binding

    companion object {
        const val TAG = "RestActivity2"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRest2Binding.inflate(layoutInflater)
