...
import com.example.dare.databinding.ActivityAbdominalCrunchesBinding
import java.util.concurrent.TimeUnit

class AbdominalCrunchesActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAbdominalCrunchesBinding

    companion object {
        const val TAG = "AbdominalCrunchesActivity"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAbdominalCrunchesBinding.inflate(layoutInflater)
    ...
    private fun rest(){
        startActivity(Intent(this, RestActivity2::class.java))
    }
