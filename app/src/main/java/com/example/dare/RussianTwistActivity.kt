...
import com.example.dare.databinding.ActivityRussianTwistBinding
import java.util.concurrent.TimeUnit

class RussianTwistActivity : AppCompatActivity() {

    private lateinit var binding: ActivityRussianTwistBinding

    companion object {
        const val TAG = "RussianTwistActivity"
    }

    private var isStarted = false
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRussianTwistBinding.inflate(layoutInflater)
    ...
    private fun rest() {
        startActivity(Intent(this, RestActivity3::class.java))
    }
